...
@NgModule({
  ...
  declarations: [
    ...
    ManageUserAddressesComponent,
    ViewDeliveryAddressComponent,
    ViewDeliveryAddressesComponent,
    ViewUserAddressComponent,
    ViewUserAddressesComponent,
    CreateLoyaltyCardComponent,
    CreateRewardCardComponent,
    EditLoyaltyCardComponent,
    EditRewardCardComponent,
    ManageLoyaltyCardsComponent,
    ManageRewardCardsComponent,
    ViewLoyaltyCardComponent,
    ViewLoyaltyCardsComponent,
    ViewRewardCardComponent,
    ViewRewardCardsComponent
  ]
})
