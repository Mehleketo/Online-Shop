    ...
    public partial class EntityModelsMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TrolleyStatuses", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DeliveryAddresses_AddressTypes_AddressTypeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RewardsCards_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Trolleys_TrolleyStatuses_StatusId",
                        column: x => x.StatusId,
                        principalTable: "TrolleyStatuses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Trolleys_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Orders_Trolleys_TrolleyId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TrolleyItems", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TrolleyItems_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TrolleyItems_Trolleys_TrolleyId",
                        column: x => x.TrolleyId,
                        principalTable: "Trolleys",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SalesRecords_Deliveries_DeliveryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DeliveryAddresses_AddressTypeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RewardsCards_UserId",
                table: "RewardsCards",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_SalesRecords_DeliveryId",
                table: "SalesRecords",
                column: "DeliveryId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TrolleyItems_ProductId",
                table: "TrolleyItems",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_TrolleyItems_TrolleyId",
                table: "TrolleyItems",
                column: "TrolleyId");

            migrationBuilder.CreateIndex(
                name: "IX_Trolleys_StatusId",
                table: "Trolleys",
                column: "StatusId");
